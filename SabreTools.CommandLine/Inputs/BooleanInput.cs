...
namespace SabreTools.CommandLine.Inputs
{
    ...
    public class BooleanInput : UserInput<bool?>
    {
        ...
        public BooleanInput(string name, string flag, string description, string? detailed = null)
            : base(name, flag, description, detailed)
        {
            Value = null;
        }

        public BooleanInput(string name, string[] flags, string description, string? detailed = null)
