...
namespace SabreTools.CommandLine.Inputs
{
    ...
    public class Int32Input : UserInput<int?>
    {
        ...
        public Int32Input(string name, string flag, string description, string? detailed = null)
            : base(name, flag, description, detailed)
        {
            Value = null;
        }

        public Int32Input(string name, string[] flags, string description, string? detailed = null)
