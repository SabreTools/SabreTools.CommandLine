...
namespace SabreTools.CommandLine.Inputs
{
    ...
    public class UInt8Input : UserInput<byte?>
    {
        ...
        public UInt8Input(string name, string flag, string description, string? detailed = null)
            : base(name, flag, description, detailed)
        {
            Value = null;
        }

        public UInt8Input(string name, string[] flags, string description, string? detailed = null)
