...
namespace SabreTools.CommandLine.Inputs
{
    ...
    public class UInt16Input : UserInput<ushort?>
    {
        ...
        public UInt16Input(string name, string flag, string description, string? detailed = null)
            : base(name, flag, description, detailed)
        {
            Value = null;
        }

        public UInt16Input(string name, string[] flags, string description, string? detailed = null)
