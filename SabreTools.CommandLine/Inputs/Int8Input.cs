...
namespace SabreTools.CommandLine.Inputs
{
    ...
    public class Int8Input : UserInput<sbyte?>
    {
        ...
        public Int8Input(string name, string flag, string description, string? detailed = null)
            : base(name, flag, description, detailed)
        {
            Value = null;
        }

        public Int8Input(string name, string[] flags, string description, string? detailed = null)
