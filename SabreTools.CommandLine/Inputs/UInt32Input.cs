...
namespace SabreTools.CommandLine.Inputs
{
    ...
    public class UInt32Input : UserInput<uint?>
    {
        ...
        public UInt32Input(string name, string flag, string description, string? detailed = null)
            : base(name, flag, description, detailed)
        {
            Value = null;
        }

        public UInt32Input(string name, string[] flags, string description, string? detailed = null)
