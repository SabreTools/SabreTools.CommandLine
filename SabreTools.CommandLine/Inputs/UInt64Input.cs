...
namespace SabreTools.CommandLine.Inputs
{
    ...
    public class UInt64Input : UserInput<ulong?>
    {
        ...
        public UInt64Input(string name, string flag, string description, string? detailed = null)
            : base(name, flag, description, detailed)
        {
            Value = null;
        }

        public UInt64Input(string name, string[] flags, string description, string? detailed = null)
